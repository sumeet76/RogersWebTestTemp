...
public class OneViewCH_TC_003_IgniteNACDualPlayWithout4KTVExpressCheckout extends BaseTestClass{
	 @Test @Parameters("strBrowser")
	    public void endToEndFlowAnonymousCustomerTriplePlayTest(String browser){
			...
			rogers_ignite_bundles_page.selectOptout(TestDataHandler.anonymousData.getplanEng(),TestDataHandler.anonymousData.getplanFr());
			rogers_ignite_bundles_page.clkAddtoCart(TestDataHandler.anonymousData.getplanEng(),TestDataHandler.anonymousData.getplanFr());
			rogers_ignite_bundles_page.activateHomePhoneltrPopUp();
			...
			fulfillment_Page.selectChkboxAgreeCondition();
