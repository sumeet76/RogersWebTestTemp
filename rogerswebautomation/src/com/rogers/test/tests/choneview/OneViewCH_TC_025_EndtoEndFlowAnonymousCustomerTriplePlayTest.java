...
public class OneViewCH_TC_025_EndtoEndFlowAnonymousCustomerTriplePlayTest extends BaseTestClass {
	...
	public void beforeTest(String strBrowser, String strLanguage,String strGroupName, ITestContext testContext, Method method) throws ClientProtocolException, IOException {
        ...
        startOVSession(TestDataHandler.chOneViewConfig.getUrl(), strBrowser, strLanguage,strGroupName,TestDataHandler.anonymousData.contactDetails.getContactID(),"",TestDataHandler.chOneViewConfig.getUsrID(), TestDataHandler.chOneViewConfig.getLoginID(), method);
