package com.rogers.pages.mobile;
...
public class MobileRogersHomePage extends BasePageClass {

	public MobileRogersHomePage(WebDriver driver) {
		super(driver);
	}

	@FindBy(xpath = "//nav[@role='menubar']//li[@id='dds_username']//a[@aria-label='Sign in to My Rogers']//span[text()='Sign in'  or text()='Connexion']")
	...
	public void clkSignIn() {		
		reusableActions.getWhenVisible(lnkViewNavigation);
