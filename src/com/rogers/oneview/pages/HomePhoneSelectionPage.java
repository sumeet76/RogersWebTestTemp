...
//	@FindBy(xpath = "//span[contains(text(),'Cancel') or contains(text(),'Annuler')]//following::button//child::span[contains(text(),'Continue') or contains(text(),'Continuer')]")
	@FindBy(xpath = "//div[@class='button-set']/child::button[@class='ds-button ds-corners ds-pointer text-center mw-100 d-inline-block -primary -large text-no-decoration']")
