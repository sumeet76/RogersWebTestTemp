...
public class RogersBFA_OV_TC01_HUPWithPPCMultiLine_ChooseDifferentPlan_Test extends BaseTestClass {
    ...
    public void hupWithPPCMultiLineChooseDifferentPlanFlow() {
        ...
        //below three are not working and add 4th check box
	...
	public void beforeTest(String strBrowser, String strLanguage, ITestContext testContext, Method method) throws ClientProtocolException, IOException {
		...
		startOVSession(TestDataHandler.bfaOneViewConfig.getRogersOVUrl(),strBrowser, strLanguage,"buyflowsoneview", TestDataHandler.buyFlowsOVtestCase01.getContactID(),TestDataHandler.buyFlowsOVtestCase01.getBanNo(),TestDataHandler.bfaOneViewConfig.getUsrID(), TestDataHandler.bfaOneViewConfig.getLoginID(),  method);
  	}
