...
public class RogersBFA_OV_TC19_NAC_ValidateOutboundCustomerWithMultipleADMSFDiscount_NonPOTG_NonPortin_HighRisk_QC_FR_Test extends BaseTestClass {
    ...
    public void rogersNACBYODOutboundPlanPortinInvoiceOnTest() {
        ...
        reporter.hardAssert(getRogersOVCheckoutPage().verifyDownPayment(deviceCost),"Downpayment amount is displayed correctly", "Downpayment not displayed correctly");
