...
public class RogersBFA_OV_TC17_NAC_CSR_Test extends BaseTestClass {
	...
	@Test(groups = {"RegressionBFA","RegressionOVBFA"})
	public void rogersNACCSRPPCMultiLineChooseDifferentPlanFlow() {
		...
		getNacDashboardPage().fillShippingAddressField(TestDataHandler.buyFlowsOVtestCase17.getShippingAddress());
		...
		//-------------------------------------Choose Phone page---------------------------------------------
		reporter.hardAssert(getRogersOVChoosePhonePage().verifyDeviceTileCTAButton(TestDataHandler.buyFlowsOVtestCase17.getDeviceName()), "phone catalogue Page appeared Successful", "phone catalogue Page did not appear");
		String deviceName = TestDataHandler.buyFlowsOVtestCase17.getDeviceName();
		...
		getRogersOVChoosePhonePage().clickDeviceTileCTAButton(TestDataHandler.buyFlowsOVtestCase17.getDeviceName());
		...
		getRogersOVPlanConfigPage().selectDeviceCostAndClickOnContinueButton(getRogersOVPlanConfigPage().getUpdatedDeviceCostIndex(TestDataHandler.buyFlowsOVtestCase17.getDeviceCostIndex()));
		reporter.reportLogPassWithScreenshot("Device cost option selected");
		getRogersOVPlanConfigPage().clickShowMoreDetails();
		getRogersOVPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersOVPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.buyFlowsOVtestCase17.getDataOptionIndex()));
		reporter.reportLogPassWithScreenshot("Data option selected");
		//getRogersOVPlanConfigPage().clickGetBPOOffer();
		//reporter.reportLogPassWithScreenshot("BPO offer selected");
		reporter.hardAssert(getRogersOVPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersOVPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.buyFlowsOVtestCase17.getTalkOptionIndex())),
		...
		String contactNumberCreateProfile=TestDataHandler.buyFlowsOVtestCase17.getContactNumber();
		...
		getRogersOVCheckoutPage().selectYearDropdownOption(TestDataHandler.buyFlowsOVtestCase17.getDateOfBirthYear());
		getRogersOVCheckoutPage().selectMonthDropdownOption(TestDataHandler.buyFlowsOVtestCase17.getDateOfBirthMonth());
		getRogersOVCheckoutPage().selectDayDropdownOption(TestDataHandler.buyFlowsOVtestCase17.getDateOfBirthDay());
		getRogersOVCheckoutPage().selectDropdownOption(TestDataHandler.buyFlowsOVtestCase17.getDropdownOption());
		getRogersOVCheckoutPage().setPassportNumber(TestDataHandler.buyFlowsOVtestCase17.getPassportNumber());
		reporter.reportLogPassWithScreenshot("PassportNumber Entered Successfully");
		//getRogersOVCheckoutPage().selectSecondDropdownOption(TestDataHandler.buyFlowsOVtestCase17.getSecondIdOption());
		getRogersOVCheckoutPage().setSINNumber(TestDataHandler.buyFlowsOVtestCase17.getSinNumber());
		...
		//reporter.hardAssert(getAccountOverViewPage().verifyAndClickWirelessCTN(TestDataHandler.buyFlowsOVtestCase17.getCtn()),"CTN Found","CTN Not Found");
		...
		//getRogersOVChoosePhonePage().searchDevice(TestDataHandler.buyFlowsOVtestCase17.getNewDevice());
		getRogersOVChoosePhonePage().selectFirstAvailableDevice();
		//reporter.reportLogWithScreenshot("Rogers Choose Phone Page , device selected " + TestDataHandler.buyFlowsOVtestCase17.getNewDevice());
		...
		//getRogersOVOrderReviewPage().selectEmailDigitalCopy(TestDataHandler.buyFlowsOVtestCase17.getUsername());
