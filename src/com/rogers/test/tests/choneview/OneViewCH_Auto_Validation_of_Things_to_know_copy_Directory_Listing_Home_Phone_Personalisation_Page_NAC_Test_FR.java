...
public class OneViewCH_Auto_Validation_of_Things_to_know_copy_Directory_Listing_Home_Phone_Personalisation_Page_NAC_Test_FR extends BaseTestClass {
    @Test
    public void oneViewCH_Auto_Validation_of_Things_to_know_copy_Directory_Listing_Home_Phone_Personalisation_Page_NAC_Test_FR(){
...
//       reporter.hardAssert(getRogersIgniteBundlesPage().verifyMonthlyFeesInCollapsible(),"Monthly Fees Displayed","Monthly Fees did not Displayed");
        ...
        reporter.softAssert(getHomePhoneSelectionPage().verifythingsToKnowFirstname(),"Updated copy of things to know is displayed","Failed");
