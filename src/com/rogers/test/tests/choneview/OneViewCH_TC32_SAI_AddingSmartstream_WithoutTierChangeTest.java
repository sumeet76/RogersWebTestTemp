...
public class OneViewCH_TC32_SAI_AddingSmartstream_WithoutTierChangeTest extends BaseTestClass {
    ...
    public void beforeTest(@Optional("chrome") String strBrowser, @Optional("en") String strLanguage, ITestContext testContext, Method method) throws ClientProtocolException, IOException {
        ...
        startOVSession(System.getProperty("QaOVUrl"), strBrowser, strLanguage, RogersEnums.GroupName.connectedhome_oneview.toString().toLowerCase().trim(), TestDataHandler.TC032_SAI_AddingSmartStream.getContactID(), TestDataHandler.TC032_SAI_AddingSmartStream.accountDetails.getBan(), System.getenv("MaestroLoginID"), System.getenv("MaestroUsrID"), method);
    }
