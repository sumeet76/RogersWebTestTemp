...
//user should
public class OneviewCH_Auto_OVS2_ISSCxWithNoPods_AgentAddingMaxBothPods_Test extends BaseTestClass {
    @Test (groups = {"Regression"})
    public void oneviewCH_Auto_OVS2_ISSCxWithNoPods_AgentAddingMaxBothPods_Test() {
