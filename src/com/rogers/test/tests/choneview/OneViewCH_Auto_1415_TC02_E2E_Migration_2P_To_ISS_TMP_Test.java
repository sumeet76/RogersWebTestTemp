...
public class OneViewCH_Auto_1415_TC02_E2E_Migration_2P_To_ISS_TMP_Test extends BaseTestClass {
	@Test (groups = {"RNAC","RegressionCHOV"})
    public void oneViewCH_Auto_1415_TC02_E2E_Migration_2P_To_ISS_TMP_Test(){
		...
		reporter.reportLogWithScreenshot("load offers");
		getRogersIgniteCampaignPage().enterCoupon("KW6");
