...
public class OneViewCH_Auto_1567_TC01_TargetedMigration_3P_to_3P_same_numbTest extends BaseTestClass {

    @Test
    public void oneViewCH_Auto_1567_TC01_TargetedMigration_3P_to_3P_same_numbTest() {
//        Launch One view
        getEnvironmentSelectionPage().launchOneView(TestDataHandler.targetedMigration_3P_to_3P_same_numb.getAccountNo(), TestDataHandler.targetedMigration_3P_to_3P_same_numb.getContactID());
...
//       Rogers Ignite page.
        ...
        //getHomePhoneSelectionPage().clickContinuebtn();
        reporter.reportLogWithScreenshot("Installation page should be visible");
