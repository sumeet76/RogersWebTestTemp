...
//NO free (restricted) pods should be displayed, MAX out for regular
public class OneViewCH_Auto_2557_TC02_Validate_maxSAICx_Pods_Test extends BaseTestClass {
    @Test (groups = {"Regression"})
    public void oneViewCH_Auto_2557_TC02_Validate_maxSAICx_Pods_Test() {
