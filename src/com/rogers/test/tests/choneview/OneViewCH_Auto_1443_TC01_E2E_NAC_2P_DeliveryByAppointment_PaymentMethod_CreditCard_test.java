...
public class OneViewCH_Auto_1443_TC01_E2E_NAC_2P_DeliveryByAppointment_PaymentMethod_CreditCard_test extends BaseTestClass {
	@Test (groups = {"RNAC","RegressionCHOV"})
	public void oneViewCH_Auto_1443_TC01_E2E_NAC_2P_DeliveryByAppointment_PaymentMethod_CreditCard_test(){
		...
		reporter.reportLogWithScreenshot("clkCollapse");
...
//		getCreditCheckPage().clickDateTimeRadioButton();
	...
	public void beforeTest(@Optional("chrome") String strBrowser, @Optional("en") String strLanguage,ITestContext testContext, Method method) throws ClientProtocolException, IOException {
		startOVSession(System.getProperty("QaOVUrl"), strBrowser, strLanguage, RogersEnums.GroupName.connectedhome_oneview.toString().toLowerCase().trim(), TestDataHandler.anonymousData.contactDetails.getContactID2PDeliveryByAppt(), "", System.getenv("MaestroLoginID"), System.getenv("MaestroUsrID"), method);
	}
