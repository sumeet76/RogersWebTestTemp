...
public class OVR_Auto_TC58_SelfServe_TV_ADD_STB_E2E_FS_GF_ON_EN_Test extends BaseTestClass {
    ...
    public void ovr_Auto_TC58_SelfServe_TV_ADD_STB_E2E_FS_GF_ON_EN_Test() {
        ...
        getAccountSearchPage().searchForAccountAndSelectEnv(TestDataHandler.tc_58_Ovr_SelfServe_IgniteTV_AddSTB.getBanNumber(), TestDataHandler.tc_58_Ovr_SelfServe_IgniteTV_AddSTB.getPostalCode(), TestDataHandler.ovrConfigData.getOvrQaEnvironment());
        ...
        getReporter().reportLogWithScreenshot("Additional TV boxes added to cart");
