...
public class OVR_Auto_TC32_NAC_ISS_with_SmartHomeMonitoring_E2E_Corp_ATL_FR_Test extends BaseTestClass {
    ...
    public void ovr_Auto_TC32_NAC_ISS_with_SmartHomeMonitoring_E2E_Corp_ATL_FR_Test() {
        ...
        getCheckAvailabilityPage().checkAvailability("43 Airport heights ,NL A1A4W8", "chrome");
        ...
        reporter.reportLogWithScreenshot("ISS with SHM add ons selected");
