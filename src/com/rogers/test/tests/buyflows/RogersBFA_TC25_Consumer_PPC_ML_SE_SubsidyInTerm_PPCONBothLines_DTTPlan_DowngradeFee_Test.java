...
/**
 * TC25 - Price plan change for an existing multi line shared account(for both lines) from Subsidy to financing_selecting Data, Talk and Text plan_Validating downgrade fee
 * @author praveen.kumar7
 */

public class RogersBFA_TC25_Consumer_PPC_ML_SE_SubsidyInTerm_PPCONBothLines_DTTPlan_DowngradeFee_Test extends BaseTestClass {
    ...
    public void tc25_rogersPPC_MLSE_SubsidyInTerm_PPCONBothLines_DTTPlanTest() {
        ...
        getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc25PPCMLSESubsidyPlanToDTTPLan.getCtn());
        ...
        getRogersPlanConfigPage().selectPlanType(TestDataHandler.tc25PPCMLSESubsidyPlanToDTTPLan.getNewPlanType(),this.getClass().getSimpleName());
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc25PPCMLSESubsidyPlanToDTTPLan.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc25PPCMLSESubsidyPlanToDTTPLan.getTalkOptionIndex())),
        ...
        getRogersPlanConfigPage().clkAddToCartAndProceedToCheckout(this.getClass().getSimpleName(), TestDataHandler.tc25PPCMLSESubsidyPlanToDTTPLan.getNewPlanType());
        //-----------------------------------------Review Order Page----------------------------------------------------
