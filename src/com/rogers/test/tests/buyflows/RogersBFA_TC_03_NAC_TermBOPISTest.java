...
public class RogersBFA_TC_03_NAC_TermBOPISTest extends BaseTestClass {
	...
	public void termBopisFlowTest() throws InterruptedException {
		...
		rogers_device_catalogue_page.validateRpotgPostalCode(TestDataHandler.tc03NACBopisTerm.getPostalCode());
		...
		rogers_plan_config_page.skipBPOOffer();
...
//		String lastName = rogers_checkout_page.setLastNameCreateProfilepage("marichale");
		...
		rogers_checkout_page.selectYearDropdownOption(TestDataHandler.tc03NACBopisTerm.getDateOfBirthYear());
		rogers_checkout_page.selectMonthDropdownOption(TestDataHandler.tc03NACBopisTerm.getDateOfBirthMonth());
		rogers_checkout_page.selectDayDropdownOption(TestDataHandler.tc03NACBopisTerm.getDateOfBirthDay());
		rogers_checkout_page.switchToCreditCardIFrame();
		rogers_checkout_page.setCreditCardNumberIFrame(TestDataHandler.tc03NACBopisTerm.getCreditCardDetails());
		...
		rogers_checkout_page.setExpiryDate(TestDataHandler.tc03NACBopisTerm.getExpiryDate());
		rogers_checkout_page.selectDropdownOption(TestDataHandler.tc03NACBopisTerm.getDropdownOption());
		rogers_checkout_page.setPassportNumber(TestDataHandler.tc03NACBopisTerm.getPassportNumber());
...
//				"Credit Evaluation Text not disaplayed on Modal");
		...
		rogers_checkout_page.selectCityDropdownOption(TestDataHandler.tc03NACBopisTerm.getCityName());
		...
		rogers_checkout_page.selectPaymentMethodDropdownOption(TestDataHandler.tc03NACBopisTerm.getPaymentMethod());
