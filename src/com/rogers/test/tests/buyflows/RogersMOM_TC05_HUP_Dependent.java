...
/**
 * TC05 - MOM - HUP Dependent Complete
 * @author Nitin.Arora
 */

public class RogersMOM_TC05_HUP_Dependent extends BaseTestClass {
    ...
    public void tc05RogersMOMHupDependent() throws InterruptedException {

        //--------- Launch login page and sign in with using email id and password---------//
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.MOM_TC05_HUP_Dependent.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.MOM_TC05_HUP_Dependent.getPassword());
        ...
        //--------- Click Manage button for dependent line ---------//
        getRogersAccountOverviewPage().clickManageButtonDep();
        ...
        String deviceName = TestDataHandler.MOM_TC05_HUP_Dependent.getDeviceName();
        ...
        getRogersDeviceCataloguePage().clickDeviceTileCTAButton(TestDataHandler.MOM_TC05_HUP_Dependent.getDeviceName());
