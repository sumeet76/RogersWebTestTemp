...
/**
 * TC34 - RPP Customer - Price plan change for an existing Multi line Shared account from Financing to BYOD plan type(DTT plan) on additional line
 * @author praveen.kumar7
 */

public class RogersBFA_TC34_RPP_PPC_ML_SE_FinOutTermToBYODPlanOnAdditionalLine_Test extends BaseTestClass {
    ...
    public void rogersPPC_TC34_ML_SE_FinOutTerm_SelectingBYODPlanTest() {
        ...
        getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc34_RPP_PPC_ML_SE_BYODToBYODPlanOnAdditionalLine.getCtn());
        ...
        getRogersPlanConfigPage().selectPlanType(TestDataHandler.tc34_RPP_PPC_ML_SE_BYODToBYODPlanOnAdditionalLine.getNewPlanType(),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Plan Type is selected successfully");
        getRogersPlanConfigPage().clickShowMoreDetails();
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc34_RPP_PPC_ML_SE_BYODToBYODPlanOnAdditionalLine.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc34_RPP_PPC_ML_SE_BYODToBYODPlanOnAdditionalLine.getTalkOptionIndex())),
