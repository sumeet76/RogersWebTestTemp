...
/**
 * TC24 - Price plan change for an existing Single line account from FIN to FIN(Data, Talk and Text Plan)
 * @author praveen.kumar7
 */

public class RogersBFA_TC24_PPC_SL_NonSE_FinancingInTerm_DTT_Test extends BaseTestClass {
    ...
    public void rogersPPC_TC24_SLNonSE_FINInTerm_DTTPlanTest() {
        ...
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc24PPCSLNonSEDTTPlan.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc24PPCSLNonSEDTTPlan.getPassword());
        ...
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc24PPCSLNonSEDTTPlan.getTalkOptionIndex())),
