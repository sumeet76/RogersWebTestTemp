...
public class RogersBFA_TC012_HUP_NPOTG_Test extends BaseTestClass {
    ...
    public void hupFlowTest() {
		...
		rogers_login_page.setUsernameIFrame(TestDataHandler.testCase12.getUsername());
		rogers_login_page.setPasswordIFrame(TestDataHandler.testCase12.getPassword());
        ...
        reporter.hardAssert(rogers_account_overview_page.verifyAndClickWirelessCTN(TestDataHandler.testCase12.getCtn()),"CTN Found","CTN Not Found");
        ...
        rogers_choose_phone_page.searchDevice(TestDataHandler.testCase12.getNewDevice());
        ...
        rogers_order_review_page.selectEmailDigitalCopy(TestDataHandler.testCase12.getUsername());
