...
/**
 * TC49 - RPP_AAL TERM_Share Everything_Selecting Upfront edge cost option, Voluntary Down payment and BOPIS shipping
 * @author praveen.kumar7
 */

public class RogersBFA_TC49_RPP_AALTerm_VDP_UpfrontEdge_Bopis_Test extends BaseTestClass {
    ...
    public void tc49_RPP_AALTerm_VDP_UpfronEdge_BopisTest() {
        reporter.reportLog("URL:" + System.getProperty("QaUrl"));
        reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
        reporter.reportLogWithScreenshot("Home Page");
        getRogersHomePage().clkSignIn();
        //getRogersLoginPage().switchToSignInIFrame();
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getPassword());
        ...
        //------------------------------------Device Catalog page--------------------------------------------
        String deviceName = TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getNewDevice();
        ...
        String aalSharingType = TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getSharingType();
        ...
        //------------------------------------Device Config page--------------------------------------------
        getRogersDeviceConfigPage().selectDeviceColor(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getDeviceColor());
        ...
        getRogersPlanConfigPage().selectDeviceCostAndClickOnContinueButton(getRogersPlanConfigPage().getUpdatedDeviceCostIndex(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getDeviceCostIndex()));
        reporter.reportLogPassWithScreenshot("Device cost option selected");
        getRogersPlanConfigPage().clickShowMoreDetails();
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getTalkOptionIndex())),
        ...
        getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc49_RPP_AALTERM_VDP_UpfronEdge_BOPIS.getCtnCity());
