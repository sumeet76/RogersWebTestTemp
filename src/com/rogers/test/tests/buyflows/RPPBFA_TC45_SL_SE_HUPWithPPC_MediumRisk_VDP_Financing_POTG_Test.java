...
/**
 * TC45 - Regression - RPP HUP-E2E-Single Line_ Medium Risk Shared Account-Validate the HUP with PPC by selecting Financing plan and POTG shipping_Chrome_EN_ON
 * @author praveen.kumar7
 */
public class RPPBFA_TC45_SL_SE_HUPWithPPC_MediumRisk_VDP_Financing_POTG_Test extends BaseTestClass{

        @Test(groups = {"RegressionBFA","RPPHUPBFA","RegressionOnlineBFA"})
        public void rppHUP_tc45_SE_MediumRisk_HUPWithPPC_VDP_POTG_Test() {

            reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
            reporter.reportLogWithScreenshot("Home Page");
            getRogersHomePage().clkSignIn();
            //getRogersLoginPage().switchToSignInIFrame();
            getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getUsername());
            getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getPassword());
            ...
            String deviceName = TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getDeviceName();
            ...
            getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getDataOptionIndex()),this.getClass().getSimpleName());
            ...
            getRogersOneTimePaymentPage().setCreditCardNumberIFrame(TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getCcNumberOTP());
            getRogersOneTimePaymentPage().switchOutOfCreditCardIFrame();
            getRogersOneTimePaymentPage().setExpiryDate(TestDataHandler.tc45_RPP_HUPWithPPC_SL_SE_MediumRisk_Financing_VDP_POTG.getExpiryDateOTP());
