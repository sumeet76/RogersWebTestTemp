...
public class RogersBFA_TC20_AALShareTerm_TabletDevice_Test extends BaseTestClass {
    ...
    public void rogersAalTabletTest() {
        ...
        String aalSharingType = TestDataHandler.tc20AALTermTablet.getSharingType();
        ...
        String deviceName = TestDataHandler.tc20AALTermTablet.getNewDevice();
        ...
        //------------------------------------Device Config page--------------------------------------------
        getRogersDeviceConfigPage().selectDeviceColor(TestDataHandler.tc20AALTermTablet.getDeviceColor());
        ...
        getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc20AALTermTablet.getCtnCity());
