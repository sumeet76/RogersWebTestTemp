...
public class RogersBFA_TC_04_NAC_RpotgNoTermTest extends BaseTestClass {
	String deviceName;
	...
	public void rogersRedesignRogersNacRpotgNoTerm() throws InterruptedException {
		...
		getRogersDeviceCataloguePage().validateRpotgPostalCode(TestDataHandler.tc04RpotgNoTerm.getPostalCode());
		...
		reporter.hardAssert(postalCode.contains(TestDataHandler.tc04RpotgNoTerm.getPostalCode()),
				"RPOTG Banner has the eligible postal code displayed", "RPOTG Banner not displayed in banner");
		String deviceName = TestDataHandler.tc04RpotgNoTerm.getDeviceName();
		...
		System.out.println(TestDataHandler.tc04RpotgNoTerm.getPostalCode());
		reporter.softAssert(
				getRogersDeviceConfigPage().verifyeligiblePostalCodeinBanner()
						.contains(TestDataHandler.tc04RpotgNoTerm.getPostalCode()),
		...
		String contactNumberCreateProfile = TestDataHandler.tc04RpotgNoTerm.getContactNumber();
		...
		String billingAddressCreateProfile = TestDataHandler.tc04RpotgNoTerm.getBillingAddress();
		...
		getRogersCheckoutPage().selectYearDropdownOption(TestDataHandler.tc04RpotgNoTerm.getDateOfBirthYear());
		getRogersCheckoutPage().selectMonthDropdownOption(TestDataHandler.tc04RpotgNoTerm.getDateOfBirthMonth());
		getRogersCheckoutPage().selectDayDropdownOption(TestDataHandler.tc04RpotgNoTerm.getDateOfBirthDay());
		getRogersCheckoutPage().switchToCreditCardIFrame();
		getRogersCheckoutPage().setCreditCardNumberIFrame(TestDataHandler.tc04RpotgNoTerm.getCreditCardDetails());
		...
		getRogersCheckoutPage().setExpiryDate(TestDataHandler.tc04RpotgNoTerm.getExpiryDate());
		getRogersCheckoutPage().selectDropdownOption(TestDataHandler.tc04RpotgNoTerm.getDropdownOption());
		getRogersCheckoutPage().setPassportNumber(TestDataHandler.tc04RpotgNoTerm.getPassportNumber());
		...
		getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc04RpotgNoTerm.getCityName());
		...
		getRogersCheckoutPage().selectPaymentMethodDropdownOption(TestDataHandler.tc04RpotgNoTerm.getPaymentMethod());
		...
		getRogersOneTimePaymentPage().setCreditCardNumberIFrame(TestDataHandler.tc04RpotgNoTerm.getCreditCardDetails());
		getRogersOneTimePaymentPage().switchOutOfCreditCardIFrame();
		getRogersOneTimePaymentPage().setExpiryDate(TestDataHandler.tc04RpotgNoTerm.getExpiryDate());
