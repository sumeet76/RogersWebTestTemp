...
/**
 * TC12 - Regression - HUP-E2E-SL Shared(Fin)-Validate the HUP by selecting Keep current plan _Chrome_EN_ON
 */
public class RogersBFA_TC12_Consumer_HUPMLBySelectingFinDevice_MultipleFinAccessories_NB_Test extends BaseTestClass{
    ...
    public void tc12rogersHUPMLFinDeviceMultiplAccessories_NB_Test() {
        ...
        String deviceName = TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getDeviceName();
        ...
        getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getCtn());
        ...
        getRogersDeviceConfigPage().addAccessoriesToCart(TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getAccessoriesCount(),
                TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getAccessory1(),TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getAccessory2());
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc12HUPWithPPC_MultipleFinAccessoriesML.getDataOptionIndex()),this.getClass().getSimpleName());
