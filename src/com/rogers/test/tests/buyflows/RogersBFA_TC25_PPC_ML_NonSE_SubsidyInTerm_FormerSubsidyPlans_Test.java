...
/**
 * TC25 - Price plan change for an existing multi line individual account from Subsidy to subsidy(Former subsidy plan)
 * @author praveen.kumar7
 */

public class RogersBFA_TC25_PPC_ML_NonSE_SubsidyInTerm_FormerSubsidyPlans_Test extends BaseTestClass {
    ...
    public void rogersPPC_TC25_MLNonSE_SubsidyInTerm_FormerSubsidyPlanTest() {
        reporter.reportLog("URL:" + System.getProperty("QaUrl"));
        reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
        reporter.reportLogWithScreenshot("Home Page");
        getRogersHomePage().clkSignIn();
        //getRogersLoginPage().switchToSignInIFrame();
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc25PPCMLNonSESubsidyPlan.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc25PPCMLNonSESubsidyPlan.getPassword());
        ...
        getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc25PPCMLNonSESubsidyPlan.getCtn());
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc25PPCMLNonSESubsidyPlan.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc25PPCMLNonSESubsidyPlan.getTalkOptionIndex())),
