...
/**
 * TC15 - Regression - HUP-E2E-SL Non Shared-Validate the HUP by selecting Keep current plan _Chrome_EN_ON
 */
public class RogersBFA_TC15_HUPNonShareKeepCurrentPlanML_Test extends BaseTestClass{

        @Test(groups = {"RegressionBFA","SanityBFA","HUPBFA"})
        public void rogersHUPNonShareKeepCurrentPlanMLTest() {
            reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
            reporter.reportLogWithScreenshot("Home Page");
            getRogersHomePage().clkSignIn();
            getRogersLoginPage().switchToSignInIFrame();
            getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc15HUPNonShareKeepCurrentPlanML.getUsername());
            getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc15HUPNonShareKeepCurrentPlanML.getPassword());
            ...
            String deviceName = TestDataHandler.tc15HUPNonShareKeepCurrentPlanML.getDeviceName();
            ...
            getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc15HUPNonShareKeepCurrentPlanML.getCtn());
