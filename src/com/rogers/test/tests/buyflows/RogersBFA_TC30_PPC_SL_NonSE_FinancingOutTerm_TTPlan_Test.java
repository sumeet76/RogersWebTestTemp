...
/**
 * TC30 - Existing single line shared account_Price plan change from Data, Talk&Text to Talk&Text plan
 * @author praveen.kumar7
 */

public class RogersBFA_TC30_PPC_SL_NonSE_FinancingOutTerm_TTPlan_Test extends BaseTestClass {
    ...
    public void rogersPPC_TC30_SLSE_FinancingOutTerm_TTPlanTest() {
        ...
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc30PPCSLNonSEFinToTTPlan.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc30PPCSLNonSEFinToTTPlan.getPassword());
