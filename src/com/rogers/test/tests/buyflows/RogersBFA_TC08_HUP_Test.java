...
public class RogersBFA_TC08_HUP_Test extends BaseTestClass {
    ...
    public void hupFlowTest() {
		...
		getRogersLoginPage().setUsernameIFrame(TestDataHandler.testCase8.getUsername());
		getRogersLoginPage().setPasswordIFrame(TestDataHandler.testCase8.getPassword());
        ...
        reporter.hardAssert(getRogersAccountOverviewPage().verifyAndClickWirelessCTN(TestDataHandler.testCase8.getCtn()),"CTN Found","CTN Not Found");
        ...
        getRogersChoosePhonePage().searchDevice(TestDataHandler.testCase8.getNewDevice());
        Boolean proOnTheGoAddressFlag  = getRogersChoosePhonePage().checkProOnTheGoAtAddress(TestDataHandler.testCase8.getPostalCode());
        ...
        getRogersOrderReviewPage().selectEmailDigitalCopy(TestDataHandler.testCase8.getUsername());
