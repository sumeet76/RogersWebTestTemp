...
/**
 * TC39 - SOHOHUP - MultiLine Account_HUP flow with PPC on Main line_Selecting VDP and POTG shipping option
 * @author praveen.kumar7
 *
 */
public class SOHOBFA_TC39_ML_SE_HUPWithPPCOnMainLine_VDP_POTG_Test extends BaseTestClass {

	@Test(groups = {"RegressionBFA","HUPBFA","RegressionOnlineBFA"})
    public void sohoHUP_tc39_ML_SE_HUPWithPPCOnMainLine_VDP_POTG_Test() {
        reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
        reporter.reportLogWithScreenshot("Home Page");
        getRogersHomePage().clkSignIn();
        //getRogersLoginPage().switchToSignInIFrame();
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getPassword());
        ...
        String deviceName = TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getDeviceName();
        ...
        getRogersDeviceCataloguePage().clickDeviceTileCTAButton(TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getDeviceName());
        ...
        getRogersDeviceCataloguePage().selectCTN(TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getCtn());
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc39_SOHOHUP_ML_SE_HUPWithPPCOnMainLine_VDP_POTG.getDataOptionIndex()),this.getClass().getSimpleName());
