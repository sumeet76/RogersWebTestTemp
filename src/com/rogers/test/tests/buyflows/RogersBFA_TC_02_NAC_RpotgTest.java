...
public class RogersBFA_TC_02_NAC_RpotgTest extends BaseTestClass {
	...
	public void redesignRogersNacRpotg() throws InterruptedException {
		...
		getRogersDeviceCataloguePage().validateRpotgPostalCode(TestDataHandler.tc02Rpotg.getPostalCode());
		...
		reporter.softAssert(getRogersDeviceConfigPage().verifyDefaultColorSelected(),
		...
		reporter.hardAssert(getRogersPlanConfigPage().verifyDefaultPrice(fullPriceValueCataloguePage),
...
//		String lastName = getRogersCheckoutPage().setLastNameCreateProfilepage("marichale");
		...
		getRogersCheckoutPage().selectYearDropdownOption(TestDataHandler.tc02Rpotg.getDateOfBirthYear());
		getRogersCheckoutPage().selectMonthDropdownOption(TestDataHandler.tc02Rpotg.getDateOfBirthMonth());
		getRogersCheckoutPage().selectDayDropdownOption(TestDataHandler.tc02Rpotg.getDateOfBirthDay());
		getRogersCheckoutPage().switchToCreditCardIFrame();
		getRogersCheckoutPage().setCreditCardNumberIFrame(TestDataHandler.tc02Rpotg.getCreditCardDetails());
		...
		getRogersCheckoutPage().setExpiryDate(TestDataHandler.tc02Rpotg.getExpiryDate());
		getRogersCheckoutPage().selectDropdownOption(TestDataHandler.tc02Rpotg.getDropdownOption());
		getRogersCheckoutPage().setPassportNumber(TestDataHandler.tc02Rpotg.getPassportNumber());
...
//				"Credit Evaluation Text not disaplayed on Modal");
		...
		getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc02Rpotg.getCityName());
		...
		getRogersCheckoutPage().selectPaymentMethodDropdownOption(TestDataHandler.tc02Rpotg.getPaymentMethod());
