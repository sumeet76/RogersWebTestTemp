...
/**
 * TC35 RPP - Verify the passcode for an Expired IDV account Price plan change for an existing Single line account from FIN to BYOD(Bring Yor Own Device) plan type and Validating downgrade fee popup
 * @author praveen.kumar7
 */

public class RogersBFA_TC35_RPP_PPC_SL_FinInTerm_selectingBYOD_DowngradeFee_Test extends BaseTestClass {
    ...
    public void rogersRPP_PPC_TC35_SL_FINInTerm_BYODPlan_DowngradeFeeTest() {
        reporter.reportLog("URL:" + System.getProperty("QaUrl"));
        reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
        reporter.reportLogWithScreenshot("Home Page");
        getRogersHomePage().clkSignIn();
        //getRogersLoginPage().switchToSignInIFrame();
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc35RPP_PPC_SL_FinToBYOD_DowngradeFee.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc35RPP_PPC_SL_FinToBYOD_DowngradeFee.getPassword());
        ...
        getRogersDeviceCataloguePage().enterPasscodeInPasscodeModal(TestDataHandler.tc35RPP_PPC_SL_FinToBYOD_DowngradeFee.getPasscode());
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc35RPP_PPC_SL_FinToBYOD_DowngradeFee.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc35RPP_PPC_SL_FinToBYOD_DowngradeFee.getTalkOptionIndex())),
