...
/**
 * TC48 - Regression - RPP - [RNAC BYOD] - BYOD with Standard Shipping_E2E
 * @author praveen.kumar7
 */

public class RogersBFA_TC48_RPP_NAC_BYOD_StdShipping_QCProvince_Test extends BaseTestClass {
	...
	public void tc48_RPP_NACBYOD_QCProvinceTest() throws InterruptedException {
		//############################Plan config page###############################
		...
		getRogersDeviceCataloguePage().enterPasscodeInPasscodeModal(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getPasscode());
		...
		getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getDataOptionIndex()),this.getClass().getSimpleName());
		...
		String contactNumberCreateProfile=TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getContactNumber();
		...
		getRogersCheckoutPage().setBillingAddressCreateProfile(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getBillingAddress());
		...
		getRogersCheckoutPage().selectYearDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getDateOfBirthYear());
		getRogersCheckoutPage().selectMonthDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getDateOfBirthMonth());
		getRogersCheckoutPage().selectDayDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getDateOfBirthDay());
		getRogersCheckoutPage().switchToCreditCardIFrame();
		getRogersCheckoutPage().setCreditCardNumberIFrame(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getCreditCardDetails());
		...
		getRogersCheckoutPage().setExpiryDate(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getExpiryDate());
		getRogersCheckoutPage().selectDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getDropdownOption());
		getRogersCheckoutPage().setPassportNumber(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getPassportNumber());
		...
		getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getCityName());
		...
		getRogersCheckoutPage().selectPaymentMethodDropdownOption(TestDataHandler.tc48_RPPNACByod_StdShipping_QCProvince.getPaymentMethod());
