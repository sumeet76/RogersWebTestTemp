...
public class RogersBFA_TC36_RPP_PPC_ML_SE_FinancingInTerm_SelectingDTTPlanONMainLine_Test extends BaseTestClass {
    ...
    public void rogersPPC_TC36_ML_SE_FinancingInTerm_SelectingDTTPlanTest() {
        ...
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc36RPP_PPC_ML_SE_SelectingDTTPlanOnMainLine.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc36RPP_PPC_ML_SE_SelectingDTTPlanOnMainLine.getPassword());
        ...
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc36RPP_PPC_ML_SE_SelectingDTTPlanOnMainLine.getTalkOptionIndex())),
        ...
        getRogersPlanConfigPage().clkAddToCartAndProceedToCheckout(this.getClass().getSimpleName(), TestDataHandler.tc36RPP_PPC_ML_SE_SelectingDTTPlanOnMainLine.getNewPlanType());
        //--------------------------------------Review Order Page-------------------------------------------------------
