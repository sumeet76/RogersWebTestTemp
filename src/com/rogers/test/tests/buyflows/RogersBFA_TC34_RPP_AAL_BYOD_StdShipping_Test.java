...
/**
 * TC34 - Rogers Add a line BYOD with Standard shipping option for a RPP account- E2E
 * @author praveen.kumar7
 */

public class RogersBFA_TC34_RPP_AAL_BYOD_StdShipping_Test extends BaseTestClass {
    ...
    public void rogersRPPAalByodStdShipTest() {
        ...
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc34RPPAALBYODStdShipping.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc34RPPAALBYODStdShipping.getPassword());
        ...
        String aalSharingType = TestDataHandler.tc34RPPAALBYODStdShipping.getSharingType();
        ...
        getRogersPlanConfigPage().selectDataOptionAndClickonContinueButton(getRogersPlanConfigPage().getupdatedDataOptionIndex(TestDataHandler.tc34RPPAALBYODStdShipping.getDataOptionIndex()),this.getClass().getSimpleName());
        reporter.reportLogPassWithScreenshot("Data option selected");
        reporter.hardAssert(getRogersPlanConfigPage().verifyTalkOptionSelectionAndAddonsContinueButton(getRogersPlanConfigPage().getupdatedTalkOptionIndex(TestDataHandler.tc34RPPAALBYODStdShipping.getTalkOptionIndex())),
        ...
        getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc34RPPAALBYODStdShipping.getCtnCity());
