...
/**
 * TC31 - SOHO Medium Risk Customer_New Activation_Upfront edge option with POTG Shipping
 * @author praveen.kumar7
 */

public class SOHOBFA_TC31_NAC_Term_MediumRisk_UE_PotgShipping_EN_Test extends BaseTestClass {
	String deviceName;
	...
	@Test(groups = {"RegressionBFA","NACBFA","SOHONACBFA","SOHOBFA"})
	public void sohoNACTermMediumRiskPotgTest() throws InterruptedException {
		...
		getRogersDeviceCataloguePage().validateRpotgPostalCode(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPostalCode());
		...
		reporter.hardAssert(postalCode.contains(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPostalCode()),
				"RPOTG Banner has the eligible postal code displayed", "RPOTG Banner not displayed in banner");
		String deviceName = TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getDeviceName();
		...
		System.out.println(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPostalCode());
		reporter.softAssert(getRogersDeviceConfigPage().verifyeligiblePostalCodeinBanner().contains(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPostalCode()),
		...
		getRogersCheckoutPage().setBusinessNumber(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getBusinessNumber());
		getRogersCheckoutPage().setContactNumberCreateProfile(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getContactNumber());
		getRogersCheckoutPage().setCompanySize(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getCompanySize());
		reporter.reportLogPassWithScreenshot("Create Profile Page details Entered till ContactNumber");
		getRogersCheckoutPage().setBillingAddressCreateProfile(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getBillingAddress());
		...
		getRogersCheckoutPage().selectYearDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getDateOfBirthYear());
		getRogersCheckoutPage().selectMonthDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getDateOfBirthMonth());
		getRogersCheckoutPage().selectDayDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getDateOfBirthDay());
		getRogersCheckoutPage().switchToCreditCardIFrame();
		getRogersCheckoutPage().setCreditCardNumberIFrame(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getCreditCardDetails());
		...
		getRogersCheckoutPage().setExpiryDate(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getExpiryDate());
		getRogersCheckoutPage().selectDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getDropdownOption());
		getRogersCheckoutPage().setPassportNumber(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPassportNumber());
		...
		getRogersCheckoutPage().selectCityDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getCityName());
		...
		getRogersCheckoutPage().selectPaymentMethodDropdownOption(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getPaymentMethod());
		...
		getRogersOneTimePaymentPage().setCreditCardNumberIFrame(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getCreditCardDetailsOTP());
		getRogersOneTimePaymentPage().switchOutOfCreditCardIFrame();
		getRogersOneTimePaymentPage().setExpiryDate(TestDataHandler.tc31SOHONACTermMediumRiskUEOptionPOTG.getExpiryDateOTP());
