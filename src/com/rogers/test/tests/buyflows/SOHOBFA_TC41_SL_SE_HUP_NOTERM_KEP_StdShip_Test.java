...
/**
 * TC41 - Regression - SOHO HUP-E2E-SL Shared - Validate the HUP flow by selecting the Noterm cost option_Chrome_EN_ON
 * @author praveen.kumar7
 */
public class SOHOBFA_TC41_SL_SE_HUP_NOTERM_KEP_StdShip_Test extends BaseTestClass{

        @Test(groups = {"RegressionBFA","NACBFABC","RegressionOnlineBFA"})
        public void sohoHUP_tc41_SL_SE_HUP_NOTERM_KEP_StdShip_Test() {
            reporter.hardAssert(getRogersHomePage().verifyHomepage(), "Home Page appeared Successful", "Home Page did not appear");
            reporter.reportLogWithScreenshot("Home Page");
            getRogersHomePage().clkSignIn();
            //getRogersLoginPage().switchToSignInIFrame();
            getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc41_SOHOHUP_SL_HUP_NOTERM_KEP_StdShip.getUsername());
            getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc41_SOHOHUP_SL_HUP_NOTERM_KEP_StdShip.getPassword());
            ...
            String deviceName = TestDataHandler.tc41_SOHOHUP_SL_HUP_NOTERM_KEP_StdShip.getDeviceName();
            ...
            getRogersOneTimePaymentPage().setCreditCardNumberIFrame(TestDataHandler.tc41_SOHOHUP_SL_HUP_NOTERM_KEP_StdShip.getCreditCardDetails());
            getRogersOneTimePaymentPage().switchOutOfCreditCardIFrame();
            getRogersOneTimePaymentPage().setExpiryDate(TestDataHandler.tc41_SOHOHUP_SL_HUP_NOTERM_KEP_StdShip.getExpiryDate());
