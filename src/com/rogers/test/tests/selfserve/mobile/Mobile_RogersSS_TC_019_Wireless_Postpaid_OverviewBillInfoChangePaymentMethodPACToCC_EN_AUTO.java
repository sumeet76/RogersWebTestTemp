...
public class Mobile_RogersSS_TC_019_Wireless_Postpaid_OverviewBillInfoChangePaymentMethodPACToCC_EN_AUTO extends BaseTestClass {	
    ...
    public void overviewBillInfoChangePaymentMethodPAC_To_CC() {
		...
		if(!rogers_account_overview_page.isSetAutoPaymentDisplayedMobile())
		{
			...
			rogers_account_overview_page.clkBillingAndPaymentsSubMenuChangePaymentMethodMobile();
			...
			reporter.reportLogWithScreenshot("Account overveiew page");
			rogers_account_overview_page.clkSetUpAutomaticPaymentMethodMobile();
		}else
		{
			rogers_account_overview_page.clkBillngsAndPaymentsSubMenuSetUpAutomaticPaymentMethodMobile();
