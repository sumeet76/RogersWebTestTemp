...
public class RogersSS_TC_121_PACMAN_VerifyFreeToPaidSubscriptionPCRChanges extends BaseTestClass {
    ...
    public void validateSignInAndAccountOverview() {
        ...
        getRogersLoginPage().setUsernameIFrame("");
        getRogersLoginPage().setPasswordIFrame("");
