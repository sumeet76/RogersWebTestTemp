...
public class RogersSearch_CBS_1383_Rendering_Suggestion_Post_THree_Character extends BaseTestClass {
    ...
    public void validateLabelVisible() {
        ...
        reporter.hardAssert(!rogers_search_page.validateLabelVisible("Suggestions"), "label Suggestion Not Visible", "label Suggestion Visible");
        reporter.hardAssert(!rogers_search_page.validateLabelVisible("Support"), "label Support Not Visible", "label Support Visible");
