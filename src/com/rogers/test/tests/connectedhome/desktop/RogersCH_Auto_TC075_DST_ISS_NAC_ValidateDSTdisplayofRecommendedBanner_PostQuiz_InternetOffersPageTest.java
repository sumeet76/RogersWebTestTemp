...
public class RogersCH_Auto_TC075_DST_ISS_NAC_ValidateDSTdisplayofRecommendedBanner_PostQuiz_InternetOffersPageTest extends BaseTestClass {
    ...
    public void rogersCH_Auto_TC075_DST_ISS_NAC_ValidateDSTdisplayofRecommendedBanner_PostQuiz_InternetOffersPage() {
        ...
        getRogersInternetPackageSelectionPage().clkTakeQuiz();
        reporter.reportLogWithScreenshot("Click Take Quiz");
        getRogersInternetPackageSelectionPage().clkInternetUsage();
        reporter.reportLogWithScreenshot("Launched QA page");
        getRogersInternetPackageSelectionPage().clkContinueQuiz();
        getRogersInternetPackageSelectionPage().clkPPLUsedInteret();
        reporter.reportLogWithScreenshot("No of peoples used internet");
        getRogersInternetPackageSelectionPage().clkContinueQuiz();
        getRogersInternetPackageSelectionPage().clkDeviceConnectedToInteret();
        reporter.reportLogWithScreenshot("No. of devices connected to internet");
        getRogersInternetPackageSelectionPage().clkContinueQuiz();
