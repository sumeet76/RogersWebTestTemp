...
public class RogersCH_TC_038_LegacyTV_DigitalTVPackageUpgradeToIgniteBundleTest extends BaseTestClass {
	...
	public void checkTVPackageUpgradeTest() {
		...
		rogers_login_page.setUsernameIFrame(TestDataHandler.tc38_DigitalTVUpgradeToIgnite.getUsername());
		rogers_login_page.setPasswordIFrame(TestDataHandler.tc38_DigitalTVUpgradeToIgnite.getPassword());
	    ...
	    rogers_account_overview_page.selectAccount(TestDataHandler.tc38_DigitalTVUpgradeToIgnite.accountDetails.getBan());
