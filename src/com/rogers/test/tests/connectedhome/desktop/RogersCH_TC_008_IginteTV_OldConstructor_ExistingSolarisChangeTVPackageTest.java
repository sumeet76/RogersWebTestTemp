...
public class RogersCH_TC_008_IginteTV_OldConstructor_ExistingSolarisChangeTVPackageTest extends BaseTestClass {
    ...
    public void checkIginteTVOldConstructorExistingSolarisChangeTVPackageTest() {
        ...
        rogers_login_page.setUsernameIFrame(TestDataHandler.tc08_SolarisTVOldConstructor.getUsername());
        rogers_login_page.setPasswordIFrame(TestDataHandler.tc08_SolarisTVOldConstructor.getPassword());
        ...
        rogers_account_overview_page.selectAccount(TestDataHandler.tc08_SolarisTVOldConstructor.accountDetails.getBan());
        ...
        rogers_solaris_tv_dashboard_page.selectSolarisTVPackage(TestDataHandler.tc08_SolarisTVOldConstructor.getAccountDetails().getUpgradePlanEn(),TestDataHandler.tc08_SolarisTVOldConstructor.getAccountDetails().getUpgradePlanFr());
