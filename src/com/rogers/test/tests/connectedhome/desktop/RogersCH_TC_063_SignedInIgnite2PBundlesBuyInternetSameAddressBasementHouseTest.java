...
public class RogersCH_TC_063_SignedInIgnite2PBundlesBuyInternetSameAddressBasementHouseTest extends BaseTestClass {
    ...
    public void checkSignedInIgnite2PBundlesBuyInternetSameAddressBasementHouseTest() {
        ...
        getRogersLoginPage().setUsernameIFrame(TestDataHandler.tc63_2PSignedInInternetBuyBasement.getUsername());
        getRogersLoginPage().setPasswordIFrame(TestDataHandler.tc63_2PSignedInInternetBuyBasement.getPassword());
        ...
        getRogersAccountOverviewPage().selectAccount(TestDataHandler.tc63_2PSignedInInternetBuyBasement.accountDetails.getBan());
        ...
        getRogersInternetDashboardPage().selectStandAloneInternetPackage(TestDataHandler.tc63_2PSignedInInternetBuyBasement.getAccountDetails().getUpgradePlanEn(),TestDataHandler.tc59_saiforIgniteBundle.getAccountDetails().getUpgradePlanFr());
