...
public class RogersCH_TC_014_IginteTV_ValidatePopularPackDashboardButtonsRepositioningTest extends BaseTestClass {
    ...
    public void checkPopularPackDashboardButtonsRepositioning() {
        ...
        getRogersAccountOverviewPage().selectAccount(TestDataHandler.tc14_solarisTVAccountPopularPackage.accountDetails.getBan());
    	reporter.hardAssert(getRogersAccountOverviewPage().verifySuccessfulLogin(),"Launched the Account Page","Account Page hasn't launched");
        reporter.reportLogWithScreenshot("Launched the Account Page");
        getRogersSolarisTVDashboardPage().clkTVBadge();
        reporter.hardAssert(getRogersSolarisTVDashboardPage().verifyFlexChannelcount(TestDataHandler.tc14_solarisTVAccountPopularPackage.accountDetails.getFlexChannelsCount()),"FlexChannel are Fourty Five","There is a ambiguity in FlexChannel count ");
