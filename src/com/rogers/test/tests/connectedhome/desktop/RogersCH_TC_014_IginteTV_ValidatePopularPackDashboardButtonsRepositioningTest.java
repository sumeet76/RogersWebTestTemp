...
public class RogersCH_TC_014_IginteTV_ValidatePopularPackDashboardButtonsRepositioningTest extends BaseTestClass {
    ...
    public void checkPopularPackDashboardButtonsRepositioning() {
        ...
        rogers_login_page.setUsernameIFrame(TestDataHandler.tc14_solarisTVAccountPopularPackage.getUsername());
        rogers_login_page.setPasswordIFrame(TestDataHandler.tc14_solarisTVAccountPopularPackage.getPassword());
        ...
        rogers_account_overview_page.selectAccount(TestDataHandler.tc14_solarisTVAccountPopularPackage.accountDetails.getBan());
    	reporter.hardAssert(rogers_account_overview_page.verifySuccessfulLogin(),"Launched the Account Page","Account Page hasn't launched");
        reporter.reportLogWithScreenshot("Launched the Account Page");
        rogers_solaris_tv_dashboard_page.clkTVBadge();
        reporter.hardAssert(rogers_solaris_tv_dashboard_page.verifyFlexChannelcount(TestDataHandler.tc14_solarisTVAccountPopularPackage.accountDetails.getFlexChannelsCount()),"FlexChannel are Fourty Five","There is a ambiguity in FlexChannel count ");
