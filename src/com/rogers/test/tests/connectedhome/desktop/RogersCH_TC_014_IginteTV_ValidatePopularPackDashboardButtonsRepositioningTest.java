...
public class RogersCH_TC_014_IginteTV_ValidatePopularPackDashboardButtonsRepositioningTest extends BaseTestClass {
    ...
    public void checkPopularPackDashboardButtonsRepositioning() {
        ...
        rogers_login_page.setUsernameIFrame(TestDataHandler.solarisTVAccountPopularPackage.getUsername());
        rogers_login_page.setPasswordIFrame(TestDataHandler.solarisTVAccountPopularPackage.getPassword());
        ...
        rogers_account_overview_page.selectAccount(TestDataHandler.solarisTVAccountPopularPackage.accountDetails.getBan());
