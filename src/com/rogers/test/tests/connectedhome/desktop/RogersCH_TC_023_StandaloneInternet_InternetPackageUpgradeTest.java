...
public class RogersCH_TC_023_StandaloneInternet_InternetPackageUpgradeTest extends BaseTestClass {
    ...
    public void checkStandalonePackageUpgrade() {
        ...
        rogers_login_page.setUsernameIFrame(TestDataHandler.tc23_standaloneInternetAccountforUpgrade.getUsername());
        rogers_login_page.setPasswordIFrame(TestDataHandler.tc23_standaloneInternetAccountforUpgrade.getPassword());
        ...
        rogers_account_overview_page.selectAccount(TestDataHandler.tc23_standaloneInternetAccountforUpgrade.accountDetails.getBan());
        ...
        rogers_internet_dashboard_page.selectStandAloneInternetPackage(TestDataHandler.tc23_standaloneInternetAccountforUpgrade.getAccountDetails().getUpgradePlanEn(),TestDataHandler.tc23_standaloneInternetAccountforUpgrade.getAccountDetails().getUpgradePlanFr());
