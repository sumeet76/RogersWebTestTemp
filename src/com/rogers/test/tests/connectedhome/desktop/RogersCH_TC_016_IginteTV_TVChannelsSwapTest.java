...
public class RogersCH_TC_016_IginteTV_TVChannelsSwapTest extends BaseTestClass {
   ...
   public void checkSolarisTVSwapChannels() {
    ...
    rogers_solaris_tv_dashboard_page.swapChannelIn(TestDataHandler.solarisTVAccount.accountDetails.getSwapInChannelOne());
    ...
    rogers_solaris_tv_dashboard_page.swapChannelIn(TestDataHandler.solarisTVAccount.accountDetails.getSwapInChannelTwo());
    reporter.reportLogWithScreenshot("Selceted the Swap-in Channel two");
    rogers_solaris_tv_dashboard_page.btnChannelAdd();
    rogers_solaris_tv_dashboard_page.btnClearSerachResults();
    rogers_solaris_tv_dashboard_page.swapChannelIn(TestDataHandler.solarisTVAccount.accountDetails.getSwapInChannelThree());
