...
public class RogersCH_Auto_TC001_ExistingSolarisCx_ValidateTVDashboard_Channels_PDFTest extends BaseTestClass {
    @Test(groups = {"SanityCH","RegressionCH","IgniteTVDashboardCH","DryRunCH"}, description = "Rogers Ignite TV Dashboard")
    public void rogersCH_Auto_TC001_ExistingSolarisCx_ValidateTVDashboard_Channels_PDF() {
