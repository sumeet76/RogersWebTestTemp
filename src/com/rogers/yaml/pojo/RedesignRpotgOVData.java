...
public class RedesignRpotgOVData {
	...
	public String getSecondIdOption() {
		return secondIdOption;
	}

	public void setSecondIdOption(String secondIdOption) {
		this.secondIdOption = secondIdOption;
	}
	...
	public String getBillingCreditCardNumber() {
		return billingCreditCardNumber;
	}

	public void setBillingCreditCardNumber(String billingCreditCardNumber) {
		this.billingCreditCardNumber = billingCreditCardNumber;
	}
