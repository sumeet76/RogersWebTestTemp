...
public class RogersChoosePlanPage extends BasePageClass {
	...
	public void clkCheckout() {
		...
		reusableActions.waitForElementInvisibility(By.xpath("//span[@translate='view_breakdown_button']"),60);
		reusableActions.clickIfAvailable(By.xpath("//section[contains(@class,'dropped-addons')]//button[@translate='_continue']"));
	}
