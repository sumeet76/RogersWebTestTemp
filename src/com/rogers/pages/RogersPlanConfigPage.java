...
public class RogersPlanConfigPage extends BasePageClass {
    ...
    @FindBy(xpath = "//div[@class='ds-step__content ds-border-bottom ds-brcolor-concrete p-16 p-md-24 ds-bgcolor-misty']//button[contains(@class,'primary -large')]")
     ...
     * @return true if breadcrum is diplayed fine else false
     * @author saurav.goyal
     */
