...
public class RogersInternetUsagePage extends BasePageClass {
	...
	@FindBy(xpath = "//h2[@id='internetUsage-monthly-tab'] | //button[@id='internetUsage-monthly-tab']")
	...
	@FindBy(xpath = "//h2[@id='internetUsage-alerts-tab'] | //button[@id='internetUsage-alerts-tab']")
